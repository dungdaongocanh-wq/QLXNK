        ...
        <form action="{{ route('export-declarations.update', $exportDeclaration) }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="date" name="expiry_date" value="{{ old('expiry_date', $exportDeclaration->expiry_date?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <select name="status"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('status') border-red-400 @enderror">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="notes" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes', $exportDeclaration->notes) }}</textarea>
                </div>
            </div>
